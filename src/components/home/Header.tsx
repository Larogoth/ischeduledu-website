  ...
  return (
    <header className="container mx-auto px-4 py-16 text-center animate-fade-in">
      <div className="relative">
        <div className="absolute inset-0 bg-app-primary opacity-5 rounded-full blur-3xl transform -translate-y-1/2"></div>
        <img
          ...
          className="mx-auto w-32 h-32 mb-6 rounded-full shadow-lg hover:scale-105 transition-transform duration-300"
          width="128"
          height="128"
        />
      </div>
      <h1 className="text-5xl md:text-7xl font-bold text-app-primary mb-4 tracking-tight font-euclid">
        iSchedulEDU
      </h1>
      <p className="text-xl md:text-2xl text-app-secondary mb-10 max-w-2xl mx-auto leading-relaxed">
