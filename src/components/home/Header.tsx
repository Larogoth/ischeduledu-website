      ...
      <div className="relative z-10">
        ...
        <div className="relative mb-8">
          ...
          <img
            ...
            className="mx-auto w-32 h-32 md:w-40 md:h-40 mb-8 object-contain shadow-2xl hover:scale-110 transition-all duration-500 ring-4 ring-background ring-opacity-50"
            width="160"
            height="160"
          />
        </div>
