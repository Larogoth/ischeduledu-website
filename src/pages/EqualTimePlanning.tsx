...
import { ChevronLeft, ChevronRight, Clock, Calculator, Share2, Save, CheckCircle } from "lucide-react";
          ...
          {JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Equal Time Planning",
                "item": "https://ischeduledu.app/equal-time-planning"
              }
            ]
          })}
        </script>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <span className="text-gray-900 dark:text-gray-100 font-semibold">Equal Time Planning</span>
            </nav>
          </div>
