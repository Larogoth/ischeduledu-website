...
import { ChevronLeft, ChevronRight, Calendar, Clock, Share2, Download, CheckCircle, Play, Plus, Settings, Bell } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                <span className="text-gray-900 dark:text-gray-100 font-semibold">Custom Schedule Guide</span>
              </nav>
            </div>
