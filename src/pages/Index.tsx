...
const Index = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#E6F3FF] via-white to-[#F0F8FF] pt-14 relative overflow-hidden">
      ...
      {reviews.length > 0 && (
        <section aria-labelledby="testimonials-title" className="py-20 bg-gradient-to-b from-[#F5F9FF] to-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-8 mb-12">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-green-600 mb-2">Hundreds</div>
