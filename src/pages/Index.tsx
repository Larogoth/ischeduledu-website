...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E6F3FF] via-white to-[#F0F8FF] relative overflow-x-hidden">
      ...
      {/* Add proper spacing for sticky navigation */}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-8">
                <div className="flex items-center gap-3 text-white">
                  ...
                  <span className="text-base sm:text-lg font-semibold">{t('cta.stats.teachers')}</span>
                </div>
                <div className="flex items-center gap-3 text-white">
                  <Clock className="w-5 h-5 sm:w-6 sm:h-6 text-blue-200" />
                  <span className="text-base sm:text-lg font-semibold">{t('cta.stats.timeSaved')}</span>
                </div>
                <div className="flex items-center gap-3 text-white">
                  <Download className="w-5 h-5 sm:w-6 sm:h-6 text-blue-200" />
                  <span className="text-base sm:text-lg font-semibold">{t('cta.stats.freeSessions')}</span>
                </div>
              </div>
              ...
              >
                <img 
                  ...
                  className="w-[250px] sm:w-[300px] h-[83px] sm:h-[100px] object-contain mx-auto"
                  width="300"
                  height="100"
                />
              </a>
          ...
          <section aria-labelledby="testimonials-title" className="py-16 bg-gradient-to-b from-white to-[#F8FBFF] relative">
            ...
            <div className="container mx-auto px-4 relative z-10">
              <div className="text-center mb-12">
                ...
                <h2 id="testimonials-title" className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-gray-900">
