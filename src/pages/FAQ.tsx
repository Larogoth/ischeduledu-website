...
const FAQ: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>FAQ | iSchedulEDU - Frequently Asked Questions</title>
        <meta name="description" content="Find answers to frequently asked questions about iSchedulEDU. Learn about emergency schedule generation, app features, technical support, and how to use the teacher scheduling app effectively." />
        ...
        <meta property="og:title" content="FAQ | iSchedulEDU - Frequently Asked Questions" />
        <meta property="og:description" content="Find answers to frequently asked questions about iSchedulEDU. Learn about emergency schedule generation, app features, and technical support." />
