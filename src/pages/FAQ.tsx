...
const FAQ: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>FAQ | iSchedulEDU - Teacher Schedule Generator Questions</title>
        <meta name="description" content="Find answers to common questions about iSchedulEDU, the emergency schedule generator for teachers. Learn about features, usage, and troubleshooting." />
        <meta name="keywords" content="iSchedulEDU FAQ, teacher schedule app questions, emergency scheduling help, classroom management app support, teacher tools FAQ" />
        <meta property="og:title" content="FAQ | iSchedulEDU - Teacher Schedule Generator Questions" />
        <meta property="og:description" content="Find answers to common questions about iSchedulEDU, the emergency schedule generator for teachers." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "mainEntity": [
              {
                "@type": "Question",
                "name": "What is iSchedulEDU and how does it help teachers?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "iSchedulEDU is an emergency schedule generator app designed specifically for teachers. It allows you to create custom school schedules in under 2 minutes, handle A/B rotations, manage early dismissals, delays, and emergency schedule changes instantly."
                }
              },
              {
                "@type": "Question",
                "name": "What types of schedule rotations does iSchedulEDU support?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "iSchedulEDU supports A/B day rotations, A/B/C rotations, and custom multi-day cycles. You can set up rotating schedules with different periods, times, and activities for each rotation day."
                }
              },
              {
                "@type": "Question",
                "name": "Can iSchedulEDU handle early dismissals and delays?",
                "acceptedAnswer": {
                  "@type": "Answer",
                  "text": "Yes, iSchedulEDU is specifically designed for early dismissals, delays, and abbreviated schedules. Simply input the shortened school day time and the app will automatically create an equal-time schedule that fits within the available time."
                }
              }
            ]
          })}
